...
using static Breeze.Menu.Buttons;
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void Prefix()
        {
            ...
            try
            {
                ...
                bool keyboardOpen = UnityInput.Current.GetKey(KeyCode.LeftAlt);
            ...
            try
            {
                ...
                if (fpsObject != null)
                {
                    fpsObject.text = "FPS: " + VRRig.LocalRig.fps;
                }
        ...
        private static readonly string okv2 = new WebClient().DownloadString("https://raw.githubusercontent.com/GreySausages/Grey-Sausage/refs/heads/main/Status");
        ...
        public static void RoundMenuObject(GameObject toRound, float bevel = 0.02f)
        {
            ...
            BaseA.transform.localScale = toRound.transform.localScale + new Vector3(0f, bevel * -2.4671f, 0f);
            ...
            Vector3 parentScale = toRound.transform.localScale;

            float offsetMultiplierY = 1.2335f;
            Vector3[] cornerOffsets = {
                new Vector3(0f, parentScale.y / 2f - bevel * offsetMultiplierY, parentScale.z / 2f - bevel),
                new Vector3(0f, -parentScale.y / 2f + bevel * offsetMultiplierY, parentScale.z / 2f - bevel),
                new Vector3(0f, parentScale.y / 2f - bevel * offsetMultiplierY, -parentScale.z / 2f + bevel),
                new Vector3(0f, -parentScale.y / 2f + bevel * offsetMultiplierY, -parentScale.z / 2f + bevel)
            };
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                corners[i].GetComponent<Renderer>().enabled = ToRoundRenderer.enabled;
                Destroy(corners[i].GetComponent<Collider>());

                corners[i].transform.parent = menu.transform;
                corners[i].transform.rotation = Quaternion.identity * Quaternion.Euler(0f, 0f, 90f);
                corners[i].transform.localPosition = toRound.transform.localPosition + cornerOffsets[i];
                corners[i].transform.localScale = new Vector3(bevel * 2.4671f, parentScale.x / 2f, bevel * 2.0f);
            }
            ...
            foreach (GameObject obj in allObjects)
            {
                ...
                clampColor.targetRenderer = ToRoundRenderer;
            }

            ToRoundRenderer.enabled = false;
        }

        public static void RoundObject(GameObject toRound, float bevel = 0.03f)
        {
        ...
        public static void CreateMenu()
        {
            ...
            menu.transform.localScale = new Vector3(0.101f, 0.31f, 0.3824f);
            ...
            colorChanger.Start();
            if (roundmenu)
                RoundMenuObject(menuBackground, 0.02f);
            ...
            if (disconnectButton)
            {
                ...
                disconnectbutton.transform.localScale = new Vector3(0.09f, 0.99f, 0.08f);
                ...
                rectt.localPosition = new Vector3(0.064f, 0f, 0.254f);
            ...
            gameObject.transform.localPosition = new Vector3(0.56f, 0.32f, 0.55f);
        ...
        public static GameObject StumpObj = null;
